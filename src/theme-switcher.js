...
function toggleTheme() {
  ...
  themeLink.setAttribute('href', `/public/CSS/themes/${nextTheme}.css`) // now set the href to the right css script
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  themeLink.setAttribute('href', `/public/CSS/themes/${saved}.css`);
});
